...
@onready var debug_toggle = $MarginContainer/VBoxContainer/DebugPanel/DebugToggle
@onready var debug_log_display = $MarginContainer/VBoxContainer/DebugPanel/DebugLog
@onready var clear_log_button = $MarginContainer/VBoxContainer/DebugPanel/DebugControls/ClearLogButton
@onready var export_log_button = $MarginContainer/VBoxContainer/DebugPanel/DebugControls/ExportLogButton
