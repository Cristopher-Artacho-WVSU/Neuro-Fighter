...
var rules = [
	...
	{
		"ruleID": 12, "prioritization": 30,
		"conditions": { "distance": { "op": ">=", "value": 400 } },
		"enemy_action": ["dash_forward"], "weight": 0.5, "wasUsed": false, "inScript": false
	},
	{
		"ruleID": 13, "prioritization": 31,
...
#CONFIRM THE ACTIONS THAT HAVE MET THE REQUIREMENT TO BE TRIGGERED
...
#FUNCTION FOR THE EXECUTION OF THE ACTIONS
